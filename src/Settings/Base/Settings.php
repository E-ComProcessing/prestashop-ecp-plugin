...
namespace Ecomprocessing\Genesis\Settings\Base;

use Ecomprocessing\Genesis\Helpers\Constants\ConfigurationKeys;
use Ecomprocessing\Genesis\Helpers\Forms\FormGenerator;
use Ecomprocessing\Genesis\Helpers\Forms\SettingsService;
...
abstract class Settings
{
    ...
    protected function getFormCredentialsFields()
    {
        return [
            $this->formFieldsBase->inputField(
                ...
                ConfigurationKeys::SETTING_ECOMPROCESSING_USERNAME
            ),
            $this->formFieldsBase->inputField(
                'Password',
                'Enter your Password, required for accessing the Genesis Gateway',
                ConfigurationKeys::SETTING_ECOMPROCESSING_PASSWORD
            ),
            $this->formFieldsBase->selectField(
                ...
                ConfigurationKeys::SETTING_ECOMPROCESSING_ENVIRONMENT,
                ConfigurationKeys::SETTING_ECOMPROCESSING_ENVIRONMENT,
    ...
    protected function getFormDefaultStructure()
    {
        return [
            'form' => [
                'legend' => [
                    'title' => $this->module->l('ecomprocessing Configuration'),
                    'icon' => 'icon-cog',
                ],
                'input' => [
    ...
    public function getConfigKeys()
    {
        return [
            ...
            ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION,
            ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION_AMOUNT,
        ];
    }
