...
namespace Ecomprocessing\Genesis\Settings\Checkout;
...
class CheckoutSettings extends Settings
{
    ...
    {
        $optionalSettings = [ConfigurationKeys::SETTING_ECOMPROCESSING_WEB_PAYMENT_FORM_ID];
        $output = '';
    ...
    {
        $defaultConfigItems = [
            ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT => '0',
            ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_TRX_TYPES => [
                Types::AUTHORIZE,
                Types::SALE,
            ],
            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_PARTIAL_CAPTURE => '1',
            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_PARTIAL_REFUND => '1',
            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_VOID => '1',
            ConfigurationKeys::SETTING_ECOMPROCESSING_ADD_JQUERY_CHECKOUT => '1',
            ConfigurationKeys::SETTING_ECOMPROCESSING_WPF_TOKENIZATION => '0',
            ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_BANK_CODES => [],
            ConfigurationKeys::SETTING_ECOMPROCESSING_THREEDS_ALLOWED => '1',
            ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION => 'low_risk',
            ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION_AMOUNT => '100',
            ConfigurationKeys::SETTING_ECOMPROCESSING_IFRAME_ALLOWED => '0',
        ];
    ...
    public function getConfigKeys()
    {
        ...
        return array_merge(
            ...
            [
                ...
                ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_TRX_TYPES,
                ConfigurationKeys::SETTING_ECOMPROCESSING_WPF_TOKENIZATION,
                ConfigurationKeys::SETTING_ECOMPROCESSING_WEB_PAYMENT_FORM_ID,
                ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_BANK_CODES,
            ]
        );
    }
    ...
    private function getFormIframeOptionFields()
    {
        return [
            $this->formFieldsBase->switchField(
                ...
                'setting inside Merchant Console. For more info ask:  tech-support@e-comprocessing.com',
                ConfigurationKeys::SETTING_ECOMPROCESSING_IFRAME_ALLOWED
            ),
        ];
    }
    ...
    private function getFormThreedsFields()
    {
        return [
            $this->formFieldsBase->switchField(
                ...
                ConfigurationKeys::SETTING_ECOMPROCESSING_THREEDS_ALLOWED
            ),
            $this->formFieldsBase->selectField(
                '3DSv2 Challenge',
                ...
                ConfigurationKeys::SETTING_ECOMPROCESSING_THREEDS_CHALLENGE_INDICATOR,
                $this->formFieldsBase->generateOptionsFromArray(EcomprocessingThreeds::getChallengeIndicators())
            ),
        ];
    }
}
