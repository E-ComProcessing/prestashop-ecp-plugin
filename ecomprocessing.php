...
use Ecomprocessing\Genesis\EcomprocessingConsumer;
use Ecomprocessing\Genesis\EcomprocessingInstall;
...
class Ecomprocessing extends PaymentModule
{
    ...
    {
        return $this->getBoolConfigurationValue(ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT);
    }
    ...
    {
        return $this->getBoolConfigurationValue(ConfigurationKeys::SETTING_ECOMPROCESSING_WPF_TOKENIZATION);
    }
    ...
    {
        return $this->getBoolConfigurationValue(ConfigurationKeys::SETTING_ECOMPROCESSING_THREEDS_ALLOWED);
    }
    ...
    {
        return $this->getBoolConfigurationValue(ConfigurationKeys::SETTING_ECOMPROCESSING_IFRAME_ALLOWED);
    }
                ...
                'transactions' => [
                    ...
                    'options' => [
                        'allow_partial_capture' => $this->getBoolConfigurationValue(
                            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_PARTIAL_CAPTURE
                        ),
                        'allow_partial_refund' => $this->getBoolConfigurationValue(
                            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_PARTIAL_REFUND
                        ),
                        'allow_void' => $this->getBoolConfigurationValue(
                            ConfigurationKeys::SETTING_ECOMPROCESSING_ALLOW_VOID
                        ),
                    ],
                    'text' => [
    ...
    public function hookDisplayOrderDetail($params)
    {
        ...
        if ($this->isPrestaVersion17() && $this->getBoolConfigurationValue(
            ConfigurationKeys::SETTING_ECOMPROCESSING_ADD_JQUERY_CHECKOUT
        )) {
    ...
    public function populateTransactionData()
    {
        ...
        $data->web_payment_form_id = Configuration::get(ConfigurationKeys::SETTING_ECOMPROCESSING_WEB_PAYMENT_FORM_ID);
        ...
        $data->threeds_challenge_indicator = Configuration::get(
            ConfigurationKeys::SETTING_ECOMPROCESSING_THREEDS_CHALLENGE_INDICATOR
        );
        ...
        // SCA Exemption
        $data->sca_exemption_value = Configuration::get(ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION);
        $data->sca_exemption_amount =
            Configuration::get(ConfigurationKeys::SETTING_ECOMPROCESSING_SCA_EXEMPTION_AMOUNT);
    ...
    private function getTransactionTypes()
    {
        ...
        $selectedTypes = $this->orderCardTransactionTypes(
            json_decode(
                Configuration::get(ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_TRX_TYPES)
            )
        );
        ...
        switch ($transactionType) {
            ...
            case Types::ONLINE_BANKING_PAYIN:
                $selectedBankCodes = json_decode(
                    Configuration::get(ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT_BANK_CODES)
                );
    ...
    {
        $toggleSettingKeys = [
            ConfigurationKeys::SETTING_ECOMPROCESSING_CHECKOUT,
        ];
