 ...
 *}
                        ...
                        <div class="form-group amount-input">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" data-toggle="{$ecomprocessing['name']['module']|escape:'htmlall':'UTF-8'}-tooltip" data-placement="top" title="{$ecomprocessing['transactions']['order']['currency']['iso_code']|escape:'htmlall':'UTF-8'}">{$ecomprocessing['transactions']['order']['currency']['sign']|escape:'htmlall':'UTF-8'}</span>
                                </div>
    ...
    <style>
        ...
        #ecomprocessing-modal .modal-header img {
            margin-right: 10px;
        }
    </style>
